...
const createCard = (title, src, text, buttonText) => {
  return { title, src, text, buttonText };
}

const Transaction = (props) => {
  const cards = [
    createCard("Pembelian", sampleSrc, "Penambahan stok barang untuk gudang", "Beli"),
    createCard("Penjualan", sampleSrc, "Penjualan barang", "Jual")
  ];
