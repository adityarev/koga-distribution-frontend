...
const createCard = (title, src, link, text) => {
  return { title, src, link, text };
}

const Home = (props) => {
  const cards = [
    createCard("Barang", sampleSrc, ITEM_LINK, "Periksa daftar barang beserta detail"),
    createCard("Transaksi", sampleSrc, TRANSACTION_LINK, "Pembelian dan penjualan stok disini"),
    createCard("Riwayat", sampleSrc, HISTORY_LINK, "Riwayat")
  ];
